...
import { SearchModal, BackToTop, TableOfContents } from '@study-ui/components'
...
export default function CustomAppLayout() {
    ...
    const isChallengePage = location.pathname.includes('/challenge/') || location.pathname.includes('/guide/')
        ...
        <div className="flex h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-hidden">
            ...
            <main ref={mainRef} className="flex-1 min-w-0 overflow-y-auto">
                <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 sticky top-0 z-20">
                    ...
                    <span className="text-sm font-bold text-pink-600 dark:text-pink-400 tracking-wider uppercase">
                        Coding Train
                    </span>
                    <button
                        onClick={openSearch}
